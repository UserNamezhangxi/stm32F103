...
int Read_Encoder(u8 TIMX)
{
    ...
    switch(TIMX)
    {
        case 2:  Encoder_TIM = (short)TIM_GetCounter(TIM2); TIM_SetCounter(TIM2, 0);break;    // Encoder_TIM= (short)TIM2 -> CNT;  TIM2 -> CNT=0;break;
        case 3:  Encoder_TIM = (short)TIM_GetCounter(TIM3); TIM_SetCounter(TIM3, 0);break;
        case 4:  Encoder_TIM = (short)TIM_GetCounter(TIM4); TIM_SetCounter(TIM4, 0);break;
